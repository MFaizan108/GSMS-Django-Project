...
class Supplier(models.Model):
    ...
    linked_account = models.OneToOneField(Account, on_delete=models.PROTECT, null=True, blank=True, related_name='supplier')
    ...
    def get_absolute_url(self):
        return reverse('suppliers:supplier_detail', args=[self.pk])
